...
url = f'https://kysing.kr/search/?keyword={search_keyword}'

song_search_url = f'https://kysing.kr/search/?category=2&keyword={search_keyword}'
singer_search_url = f'https://kysing.kr/search/?category=7&keyword={search_keyword}'
...
all_search = soup.select('.search_tab_box .search_tab')
